...
class Chats extends React.Component{
  constructor(props){
    ...
    this.state={
      Details:[
           {id:1,img_uri:"https://e7.pngegg.com/pngimages/119/921/png-clipart-flower-dahlia-flower-flower-garden-annual-plant.png",time:new Date().toLocaleTimeString([], { hour: '2-digit', minute: "2-digit", hour12:true }),name:"oranges",chat:"hai"},
  ...
  render(){
    console.log("fil",this.props.filterData)
